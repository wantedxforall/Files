...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2024 at 02:53 PM
...
INSERT INTO `ads` (`id`, `ad_type_id`, `ad_name`, `title`, `code`, `redirect_url`, `image`, `resolution`, `status`, `created_at`, `updated_at`) VALUES
(36, 16, 'Leaderboard Banner', 'ad-1', 'ad_q5eg', 'https://wstacks.com/', '657abf4d13b7b1702543181.png', '728x90', 1, '2023-12-14 07:57:38', '2023-12-14 08:39:41');
...
(79, 'footer_important_links.element', '{\"title\":\"Buy Credits\",\"url\":\"plan\"}', '2024-05-01 10:00:30', '2024-05-01 10:00:30'),
...
(49, 21, 1000, 'Manual', 'manual', 1, '[]', '[]', 0, NULL, '<p>Please Provide Your Information</p>', '2024-05-04 08:39:13', '2024-05-04 08:39:19');
...
CREATE TABLE `general_settings` (
  ...
  `deduct_credits` int(11) DEFAULT 0,
...
INSERT INTO `general_settings` (`id`, `site_name`, `cur_text`, `cur_sym`, `email_from`, `email_template`, `sms_body`, `sms_from`, `base_color`, `secondary_color`, `mail_config`, `sms_config`, `global_shortcodes`, `kv`, `ev`, `en`, `sv`, `sn`, `force_ssl`, `maintenance_mode`, `secure_password`, `agree`, `registration`, `active_template`, `deduct_credits`, `add_credits`, `given_credits`, `auto_approved`, `system_info`, `created_at`, `updated_at`) VALUES
(1, 'Follow Exchange', 'USD', '$', 'no-reply@baronmeddy.com', '<p>Hi {{fullname}} ({{username}}),&nbsp;</p><p>{{message}}</p>', 'Hi {{fullname}} ({{username}}), \r\n{{message}}', 'Minstack', '4430b5', '060662', '{\"name\":\"smtp\",\"host\":\"business32.web-hosting.com\",\"port\":\"465\",\"enc\":\"ssl\",\"username\":\"no-reply@baronmeddy.com\",\"password\":\"Pl@medie10\\\"_\\\"\"}', '{\"name\":\"nexmo\",\"clickatell\":{\"api_key\":\"----------------\"},\"infobip\":{\"username\":null,\"password\":null},\"message_bird\":{\"api_key\":null},\"nexmo\":{\"api_key\":\"85c23125\",\"api_secret\":\"Qjd2wvzDFhPMNuAG\"},\"sms_broadcast\":{\"username\":null,\"password\":null},\"twilio\":{\"account_sid\":\"-----------------------\",\"auth_token\":\"---------------------------\",\"from\":\"----------------------\"},\"text_magic\":{\"username\":null,\"apiv2_key\":null},\"custom\":{\"method\":\"get\",\"url\":\"https:\\/\\/hostname\\/demo-api-v1\",\"headers\":{\"name\":[\"api_key\"],\"value\":[\"test_api 555\"]},\"body\":{\"name\":[\"from_number\"],\"value\":[\"5657545757\"]}}}', '{\n    \"site_name\":\"Name of your site\",\n    \"site_currency\":\"Currency of your site\",\n    \"currency_symbol\":\"Symbol of currency\"\n}', 0, 1, 1, 1, 0, 0, 0, 0, 1, 1, 'default', 1, 1, 4, 1, '[]', NULL, '2024-05-04 09:13:48');
